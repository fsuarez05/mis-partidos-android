...
class MatchSummary {
    ...
    private static void readTeam(JSONObject j,TeamInfo out){if(j==null)return;out.name=ApiClient.displayTeamName(j.optString("nombre"));out.form=j.optString("comoLlega");out.quality=j.optString("calidadInformacion");}
}
